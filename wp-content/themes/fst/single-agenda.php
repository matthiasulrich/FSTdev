...
<?php 
//Array mit Aufführungsdaten befüllen
if( have_rows('datum_repeater') ):
	while ( have_rows('datum_repeater') ) : 
		the_row();
		$sub_value = get_sub_field('datum');
		echo $sub_value;
...
<?php endwhile; endif; //post_loop ?>
	...
	<div class="mehr"><a class="button_box colored_link" href="<?php echo get_post_type_archive_link( "agenda" ); ?>"><?php the_field("link_text_upcoming_events","option"); ?></a></div>
	<?php endif; ?>
