...
// init Isotope
var $grid = $('.repertoire_container').isotope({
  itemSelector: '.repertoire_eintrag',
  layoutMode: 'fitRows',
  getSortData: {
    nachname: '.komponist-nachname',
	werktitel: '.werk_titel',
	entstehungsjahr: '.entstehungs-jahr',
}
});
...
\* =============================================================== */ 
  $( ".wp-block-lazyblock-auffuhrung" ).last().css( "margin-bottom", "2em" );
...
\* =============================================================== */ 
$(".repertoire_eintrag .audio_button.play").on('click', function(){
	$(this).closest(".repertoire_container").find(".audio_button.pause").addClass("disabled");
	$(this).closest(".repertoire_container").find(".audio_button.play").removeClass("disabled");
	$(this).siblings().removeClass("disabled");
	$(this).addClass("disabled");
})
$(".repertoire_eintrag .audio_button.pause").on('click', function(){
	$(this).closest(".repertoire_container").find(".audio_button.play").addClass("disabled");
	$(this).closest(".repertoire_container").find(".audio_button.pause").removeClass("disabled");
	$(this).siblings().removeClass("disabled");
	$(this).addClass("disabled");
})
